...
# (str) Package name
package.name = dubbingstudio

# (str) Package domain (needed for android/ios packaging)
package.domain = org.omda
...
# ⚠️⚠️ هنا أهم تعديل: أضفنا المكتبات المطلوبة ⚠️⚠️
requirements = python3,kivy,requests,arabic-reshaper,python-bidi,ffmpeg-python,plyer,urllib3,chardet,idna,certifi
...
# (list) Permissions
# ⚠️⚠️ هنا ثاني أهم تعديل: صلاحيات النت والذاكرة ⚠️⚠️
